...
public static class ComponentSolverFactory
{
    ...
    static ComponentSolverFactory()
    {
       ...
       //Hexi Modules
        ...
        ModComponetSolverInformation["SouvenirModule"] = new ModuleInformation { moduleScore = 5, helpText = "Submit the correct response with !{0} answer 3. Order is from top to bottom, then left to right."};
